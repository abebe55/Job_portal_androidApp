...
const styles = StyleSheet.create({
  ...
  postBtn:      { backgroundColor: '#fff', borderWidth: 1.5, borderColor: '#93c5fd', paddingHorizontal: 20, paddingVertical: 10, borderRadius: 8, marginTop: 4, flexDirection: 'row', alignItems: 'center', gap: 6 },
